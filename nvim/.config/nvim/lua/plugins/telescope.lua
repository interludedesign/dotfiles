return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>fd", function() M.search_docs(false) end, { noremap = true, desc = "Search Docs" })
        vim.keymap.set("n", "<leader>fD", function() M.search_docs(true) end, { noremap = true, desc = "Live Search Docs" })
